...
SaveXTube 是一个智能多媒体下载工具，支持视频、音乐、磁力链接等多种内容下载，特别针对 NAS 环境进行了优化。

## 🎯 两种使用模式

### 📱 Telegram 机器人模式
基于 Telegram 的智能下载机器人，私密安全，支持自动识别链接和实时进度推送。

### 🌐 网页前端模式
**新增功能！** 通过浏览器直接访问下载界面，无需 Telegram 客户端，即开即用。

访问地址: `http://你的服务器IP:8530/`
...
3. **支持的平台**
   - YouTube、B站、网易云音乐、QQ音乐
   - Apple Music、YouTube Music
   - X (Twitter)、Instagram、抖音、快手
   - 小红书、Telegram 等

4. **高级选项**
   - 视频质量选择（最佳/1080p/720p/480p）
   - 格式选择（自动/MP4/MP3）
